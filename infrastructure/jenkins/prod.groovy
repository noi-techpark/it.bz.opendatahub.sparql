pipeline {
    ...
    environment {
        ...
        KEYCLOAK_ALLOWED_GROUPS = credentials('it.bz.opendatahub.sparql.KEYCLOAK_ALLOWED_GROUPS')
        AUTH_PROXY_COOKIE_SECRET = credentials('it.bz.opendatahub.sparql.AUTH_PROXY_COOKIE_SECRET')
    }
