...
CREATE FUNCTION accommodationroomsopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_accommodationroomsopen
    ...
    FOR EACH ROW
EXECUTE PROCEDURE accommodationroomsopen_fn();
...
CREATE FUNCTION accommodationsopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_accommodationsopen
    BEFORE INSERT
    ON accommodationsopen
    FOR EACH ROW
EXECUTE PROCEDURE accommodationsopen_fn();

ALTER TABLE accommodationsopen
    ENABLE ALWAYS TRIGGER t_accommodationsopen;
...
CREATE FUNCTION activitiesopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_activitiesopen
    BEFORE INSERT
    ON activitiesopen
    FOR EACH ROW
EXECUTE PROCEDURE activitiesopen_fn();

ALTER TABLE activitiesopen
    ENABLE ALWAYS TRIGGER t_activitiesopen;
...
CREATE TRIGGER t_areas
    BEFORE INSERT
    ON areas
    FOR EACH ROW
EXECUTE PROCEDURE areas_fn();

ALTER TABLE areas
    ENABLE ALWAYS TRIGGER t_areas;
...
CREATE FUNCTION articlesopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_articlesopen
    BEFORE INSERT
    ON articlesopen
    FOR EACH ROW
EXECUTE PROCEDURE articlesopen_fn();

ALTER TABLE articlesopen
    ENABLE ALWAYS TRIGGER t_articlesopen;
...
CREATE FUNCTION districtsopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_districtsopen
    BEFORE INSERT
    ON districtsopen
    FOR EACH ROW
EXECUTE PROCEDURE districtsopen_fn();

ALTER TABLE districtsopen
    ENABLE ALWAYS TRIGGER t_districtsopen;
...
CREATE FUNCTION eventeuracnoi_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_eventeuracnoi
    BEFORE INSERT
    ON eventeuracnoi
    FOR EACH ROW
EXECUTE PROCEDURE eventeuracnoi_fn();

ALTER TABLE eventeuracnoi
    ENABLE ALWAYS TRIGGER t_eventeuracnoi;
...
CREATE TRIGGER t_eventsopen
    BEFORE INSERT
    ON eventsopen
    FOR EACH ROW
EXECUTE PROCEDURE eventsopen_fn();

ALTER TABLE eventsopen
    ENABLE ALWAYS TRIGGER t_eventsopen;
...
CREATE FUNCTION experienceareas_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_experienceareas
    BEFORE INSERT
    ON experienceareas
    FOR EACH ROW
EXECUTE PROCEDURE experienceareas_fn();

ALTER TABLE experienceareas
    ENABLE ALWAYS TRIGGER t_experienceareas;
...
CREATE FUNCTION gastronomiesopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_gastronomiesopen
    BEFORE INSERT
    ON gastronomiesopen
    FOR EACH ROW
EXECUTE PROCEDURE gastronomiesopen_fn();

ALTER TABLE gastronomiesopen
    ENABLE ALWAYS TRIGGER t_gastronomiesopen;
...
CREATE FUNCTION ltstaggingtypes_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_ltstaggingtypes
    BEFORE INSERT
    ON ltstaggingtypes
    FOR EACH ROW
EXECUTE PROCEDURE ltstaggingtypes_fn();

ALTER TABLE ltstaggingtypes
    ENABLE ALWAYS TRIGGER t_ltstaggingtypes;
...
CREATE FUNCTION measuringpoints_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_measuringpoints
    BEFORE INSERT
    ON measuringpoints
    FOR EACH ROW
EXECUTE PROCEDURE measuringpoints_fn();

ALTER TABLE measuringpoints
    ENABLE ALWAYS TRIGGER t_measuringpoints;
...
CREATE FUNCTION metaregionsopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_metaregionsopen
    BEFORE INSERT
    ON metaregionsopen
    FOR EACH ROW
EXECUTE PROCEDURE metaregionsopen_fn();

ALTER TABLE metaregionsopen
    ENABLE ALWAYS TRIGGER t_metaregionsopen;
...
CREATE FUNCTION municipalitiesopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_municipalitiesopen
    BEFORE INSERT
    ON municipalitiesopen
    FOR EACH ROW
EXECUTE PROCEDURE municipalitiesopen_fn();

ALTER TABLE municipalitiesopen
    ENABLE ALWAYS TRIGGER t_municipalitiesopen;
...
CREATE TRIGGER t_poisopen
    BEFORE INSERT
    ON poisopen
    FOR EACH ROW
EXECUTE PROCEDURE poisopen_fn();

ALTER TABLE poisopen
    ENABLE ALWAYS TRIGGER t_poisopen;
...
CREATE FUNCTION regionsopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_regionsopen
    BEFORE INSERT
    ON regionsopen
    FOR EACH ROW
EXECUTE PROCEDURE regionsopen_fn();

ALTER TABLE regionsopen
    ENABLE ALWAYS TRIGGER t_regionsopen;
...
CREATE FUNCTION skiareasopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_skiareasopen
    BEFORE INSERT
    ON skiareasopen
    FOR EACH ROW
EXECUTE PROCEDURE skiareasopen_fn();

ALTER TABLE skiareasopen
    ENABLE ALWAYS TRIGGER t_skiareasopen;
...
CREATE FUNCTION skiregionsopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_skiregionsopen
    BEFORE INSERT
    ON skiregionsopen
    FOR EACH ROW
EXECUTE PROCEDURE skiregionsopen_fn();

ALTER TABLE skiregionsopen
    ENABLE ALWAYS TRIGGER t_skiregionsopen;
...
CREATE FUNCTION smgpoisopen_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_smgpoisopen
    BEFORE INSERT
    ON smgpoisopen
    FOR EACH ROW
EXECUTE PROCEDURE smgpoisopen_fn();

ALTER TABLE smgpoisopen
    ENABLE ALWAYS TRIGGER t_smgpoisopen;
...
CREATE TRIGGER t_smgtags
    BEFORE INSERT
    ON smgtags
    FOR EACH ROW
EXECUTE PROCEDURE smgtags_fn();

ALTER TABLE smgtags
    ENABLE ALWAYS TRIGGER t_smgtags;
...
CREATE FUNCTION suedtiroltypes_fn()
    RETURNS TRIGGER
AS $$
BEGIN
...
CREATE TRIGGER t_suedtiroltypes
    BEFORE INSERT
    ON suedtiroltypes
    FOR EACH ROW
EXECUTE PROCEDURE suedtiroltypes_fn();

ALTER TABLE suedtiroltypes
    ENABLE ALWAYS TRIGGER t_suedtiroltypes;
...
CREATE TRIGGER t_tvsopen
    BEFORE INSERT
    ON tvsopen
    FOR EACH ROW
EXECUTE PROCEDURE tvsopen_fn();

ALTER TABLE tvsopen
    ENABLE ALWAYS TRIGGER t_tvsopen;
...
CREATE TRIGGER t_wines
    BEFORE INSERT
    ON wines
    FOR EACH ROW
EXECUTE PROCEDURE wines_fn();

ALTER TABLE wines
    ENABLE ALWAYS TRIGGER t_wines;
